...
if ($_SESSION['authenticated'] != true) {
    header("LOCATION: custom-message/index.php");
}
?>
<!DOCTYPE html>
<html>
    ...
    <body>
        ...
        <?php while ($row = $messages->fetch_assoc()) { ?>
                            ...
                            <tr class="form-group">
                                <td>
                                    <textarea name="<?php echo $i ?>[Message]" class="form-control message-field" required rows="3" placeholder="Enter a message"><?php echo $row['Message'] ?></textarea>
                                </td>
                                <td class="form-group">
                                    <select class="form-control" name="<?php echo $i ?>[Days]">
                                        <?php generateOptions($days, $row, "Days"); ?>
                                    </select>
                                </td>
                                <td>
                                    <select class="form-control" name="<?php echo $i ?>[Members]">
                                        <?php generateOptions($members, $row, "Members"); ?>
                                    </select>
                                </td>
                                <td>
                                    <select class="form-control" name="<?php echo $i ?>[Schools]">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <br><br>
                                <h3>to 
                                    <?php echo ucfirst($who['members']); ?> members at 
                                    <?php echo ucfirst($who['schools']); ?> schools?</h3>
                              </div>
        ...
        <script src="http://getschedu.com/res/js/jquery-character-count.min.js"></script>
        <script>
